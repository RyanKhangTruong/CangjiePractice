...
root = Tk()
root.title("Cangjie Practice")

def choose_shape():
    chdir("cangjie_shapes")
    # Get list of letters
    letter_list = listdir()
    if ".DS_Store" in letter_list: letter_list.remove(".DS_Store")
    if "cangjie_archive" in letter_list: letter_list.remove("cangjie_archive")
    # Choose a letter
    ...
    return f'cangjie_shapes/{letter}/{shape}'
